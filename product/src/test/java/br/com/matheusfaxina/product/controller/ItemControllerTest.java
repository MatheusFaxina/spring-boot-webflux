...
public class ItemControllerTest {
    ...
    public void getAllItems() {
        webTestClient.get().uri(ItemConstants.END_POINT_ITEM)
                .exchange()
                .expectStatus().isOk()
    ...
    public void getAllItemsApproach2() {
        Flux<Item> itemsFlux = webTestClient.get().uri(ItemConstants.END_POINT_ITEM)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(MediaType.APPLICATION_JSON)
    ...
    public void getOneItem() {
        webTestClient.get().uri(ItemConstants.END_POINT_ITEM.concat("/{id}"), "ABC")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void getOneItemNotFound() {
        webTestClient.get().uri(ItemConstants.END_POINT_ITEM.concat("/{id}"), "NOT_FOUND")
                .exchange()
    ...
    public void createItem() {
        ...
        webTestClient.post().uri(ItemConstants.END_POINT_ITEM)
    ...
    public void deleteItem() {
        webTestClient.delete().uri(ItemConstants.END_POINT_ITEM.concat("/{id}"), "ABC")
    ...
    public void updateItem() {
        ...
        webTestClient.put().uri(ItemConstants.END_POINT_ITEM.concat("/{id}"), "ABC")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
                .body(Mono.just(item), Item.class)
                .exchange()
    ...
    public void updateItemNotFound() {
        ...
        webTestClient.put().uri(ItemConstants.END_POINT_ITEM.concat("/{id}"), "NOT_FOUND")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
                .body(Mono.just(item), Item.class)
                .exchange()
    ...
    public void runtimeException() {
        webTestClient.get().uri(ItemConstants.END_POINT_ITEM + "/runtime-exception")
                .exchange()
